...
description: NestJS best practices guide — 40 rules across architecture, dependency injection, security, performance, testing, database, and API design. Use when generating, reviewing, or refactoring any NestJS code.
---
